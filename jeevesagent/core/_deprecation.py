...
:class:`JeevesDeprecationWarning` once per process per site,
naming the protocol method and the v1.0 removal target.

Two pieces:

* :class:`JeevesDeprecationWarning` — a ``DeprecationWarning``
...
class JeevesDeprecationWarning(DeprecationWarning):
    """Marker class for JeevesAgent deprecations.
    ...
    ``pytest.warns(JeevesDeprecationWarning)``.
    """
...
def warn_legacy_protocol(
    ...
    *,
    ...
    warnings.warn(
        ...
        f"removed in jeevesagent {removal}. Update your "
